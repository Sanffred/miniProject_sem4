...
class MainWindowController:
    ...
    def upload_file(service, file_path, parent_id=None):
        ...
        print(f"Attempting to upload file: {file_name} at {file_path} with metadata: {file_metadata}")
        ...
        try:
            ...
            print(f"Details: {error.resp.status}, {error.content}")
            return None
    ...
    def upload_folder(service, folder_path, parent_id=None):
        ...
        print(f"Creating folder: {folder_name}, with metadata: {folder_metadata}")
        ...
        try:
            ...
            print(f"Response Status: {error.resp.status}, Response Content: {error.content}")
        except Exception as e:
            print(f"An unexpected error occurred: {e}")
