...
"")
        ...
        self.storage_label.setGeometry(QtCore.QRect(120, 30, 250, 200))
        self.storage_label.setMinimumSize(QtCore.QSize(250, 200))
        self.storage_label.setMaximumSize(QtCore.QSize(50, 50))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Light")
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.folder_name_label = QtWidgets.QLabel(self.frame_5)
        self.folder_name_label.setGeometry(QtCore.QRect(120, 20, 250, 200))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift Light")
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.folder_name_label.setFont(font)
        self.folder_name_label.setAlignment(QtCore.Qt.AlignCenter)
        self.folder_name_label.setObjectName("folder_name_label")
        ...
        self.gdrive_toggle.setGeometry(QtCore.QRect(80, 30, 60, 30))
        font = QtGui.QFont()
        ...
        self.dropbox_toggle.setGeometry(QtCore.QRect(80, 110, 60, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.localdir_toggle = QCustomCheckBox(self.frame_6)
        self.localdir_toggle.setGeometry(QtCore.QRect(80, 200, 60, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.localdir_toggle.setFont(font)
        self.localdir_toggle.setText("")
        self.localdir_toggle.setIconSize(QtCore.QSize(25, 25))
        self.localdir_toggle.setObjectName("localdir_toggle")
        self.gdrive_btn = QtWidgets.QPushButton(self.frame_6)
        self.gdrive_btn.setGeometry(QtCore.QRect(150, 17, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gdrive_btn.setIconSize(QtCore.QSize(30, 30))
        self.gdrive_btn.setObjectName("gdrive_btn")
        self.dropbox_btn = QtWidgets.QPushButton(self.frame_6)
        self.dropbox_btn.setGeometry(QtCore.QRect(150, 107, 141, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.dropbox_btn.setIconSize(QtCore.QSize(30, 30))
        self.dropbox_btn.setObjectName("dropbox_btn")
        self.local_dir_btn = QtWidgets.QPushButton(self.frame_6)
        self.local_dir_btn.setGeometry(QtCore.QRect(150, 187, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.local_dir_btn.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/folder-svgrepo-com (1).svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.local_dir_btn.setIcon(icon2)
        self.local_dir_btn.setIconSize(QtCore.QSize(30, 30))
        self.local_dir_btn.setObjectName("local_dir_btn")
        self.verticalLayout_3.addWidget(self.frame_6)
        self.frame_7 = QtWidgets.QFrame(self.frame_3)
        self.frame_7.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_7.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_7.setObjectName("frame_7")
        self.folder_name_textarea = QtWidgets.QTextEdit(self.frame_7)
        self.folder_name_textarea.setGeometry(QtCore.QRect(70, 90, 311, 41))
        self.folder_name_textarea.setObjectName("folder_name_textarea")
        ...
        self.gdrive_toggle.customizeQCustomCheckBox(**checkBoxStyles)
        self.dropbox_toggle.customizeQCustomCheckBox(**checkBoxStyles)
        self.localdir_toggle.customizeQCustomCheckBox(**checkBoxStyles)

        self.gdrive_toggle.setFixedSize(200, 30)
        self.dropbox_toggle.setFixedSize(200, 30)
        self.localdir_toggle.setFixedSize(200, 30)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.folder_name_label.setText(_translate("MainWindow", "Folder Name "))
        self.gdrive_btn.setText(_translate("MainWindow", "Google Drive"))
        self.dropbox_btn.setText(_translate("MainWindow", "Dropbox"))
        self.local_dir_btn.setText(_translate("MainWindow", "Local Directory"))
